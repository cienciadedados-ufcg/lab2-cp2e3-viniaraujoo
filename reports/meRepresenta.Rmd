...
Para isso analisamos como está a distribuição de homens e mulheres nos dados

```{r}
        
```

Como podemos observa o número de candidatos do genero Masculino quase o dobro do gênero Feminino.
